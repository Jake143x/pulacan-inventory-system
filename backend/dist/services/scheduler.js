 ...
 */
export async function runScheduledAIAndNotify() {
    try {
        ...
        const message = highRisk.length > 0 || needReorder.length > 0
...
async function runScheduledRiskCheck() {
    try {
...
export function startScheduledAI() {
    setTimeout(() => {
