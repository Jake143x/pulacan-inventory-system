...
export type BusinessReport = {
  ...
  insights: Array<{ title: string; text: string; impact: InsightImpact; confidence: number }>;
  forecast: {
...
export async function buildBusinessReport(prisma: PrismaClient, startDate?: string, endDate?: string): Promise<BusinessReport> {
  ...
  const insights: Array<{ title: string; text: string; impact: InsightImpact; confidence: number }> = [];
